<?php
    ...
    // Check if user requested an upload
    if(isset($_POST["upload"]) && isset($_FILES["fileUpload"])){
        $upload_result = upload($_FILES);
    }
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="jumbotron text-justify">
                ...
                <div class="container text-center">
                    <div class="row justify-content-center">
                        <a class="btn btn-primary text-uppercase mr-2" target="_blank" href="/<?php echo $_SESSION['dir_path']; ?>">View your files</a>
                    </div>
                    <div class="row mt-3 justify-content-center">
                        <form method="POST" enctype="multipart/form-data" action="">
                            ...
                            <input type="submit" name="upload" value="Upload" class="btn btn-success text-uppercase">
                        </form>
                    </div>
                    <div class="row justify-content-center mt-2">
                        <?php
                            ...
                            <h4 class="text-success"><?php echo $upload_result["message"]; ?></h4>
                        <?php
                                else:
                        ?>
                            <h4 class="text-danger"><?php echo $upload_result["message"]; ?></h4>
                        <?php
                                endif;
                            endif;
                        ?>
